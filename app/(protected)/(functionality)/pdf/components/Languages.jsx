...
import { Languages as LanguagesType, ResumeType } from './types';
                        ...
                        {Object.keys(item)
                            ...
                            .map((field) => (
                                <div key={field} className="mb-2">
                                    ...
                                    {isEditing(item.id) ? <InputText value={item[field] || ''} onChange={(e) => handleInputChange(index, field, e)} className="w-full" /> : <p className="text-gray-700">{item[field]}</p>}
                                </div>
                            ))}
                    </div>
                </div>
